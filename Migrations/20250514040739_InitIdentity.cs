        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterSource = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndexNews", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastDividendDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DividendYield = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DividendMonth = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IndustryCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DividendFrequency = table.Column<int>(type: "int", nullable: true),
                    FiveYearTrend = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    BetaValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    BuySellAction = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArticlePosts_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticlePosts_CategoryId",
                table: "ArticlePosts",
                column: "CategoryId");
